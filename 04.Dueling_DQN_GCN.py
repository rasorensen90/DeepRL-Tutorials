...
for frame_idx in range(1, config.MAX_FRAMES + 1):
    ...
    if frame_idx % args.log_interval == 0:
        ...
        try:
            ...
            time_get, time_step, time_update = 0,0,0
            plot_all_data(log_dir, env_id, 'BHSDuelingDQN', config.MAX_FRAMES, bin_size=(10, 100, 100, 1), smooth=1, time=timedelta(seconds=int(timer()-start)), save_filename='GCN_results.png', ipynb=False)
        except IOError:
            pass
